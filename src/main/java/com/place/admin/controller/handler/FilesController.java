...
import com.place.admin.message.ResponseMessage;
import com.place.admin.model.FileInfo;
...
public class FilesController {
  ...
  public ResponseEntity< ResponseMessage >
      uploadFile( @RequestParam( "files" ) MultipartFile[] files )
  {
    String message = "";
    try {
